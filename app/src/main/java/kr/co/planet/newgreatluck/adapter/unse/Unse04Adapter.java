...
public class Unse04Adapter extends RecyclerView.Adapter<Unse04Adapter.ViewHolder> implements View.OnClickListener {
    ...
    private InfoData myInfo, otherInfo;
    ...
    public Unse04Adapter(Activity act, ArrayList<String> contents_list, ArrayList<Integer> star_list, ArrayList<String> title_list, ArrayList<CharmData> charmAdsList, int title_drawable, String title, int type) {
        this.act = act;
    ...
    @NonNull
    @Override
    public Unse04Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_unse_contents_04, viewGroup, false);
        Unse04Adapter.ViewHolder viewHolder = new Unse04Adapter.ViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(@NonNull Unse04Adapter.ViewHolder holder, int i) {
        if (i == 0) {
            ...
            if (type == TYPE_HEART && i == 1) {
                holder.ll_constellation.setVisibility(View.VISIBLE);
                holder.today_total_fortune.setVisibility(View.GONE);


                // set constellation image
                TypedArray imags = act.getResources().obtainTypedArray(R.array.constellation_drawable);
                holder.iv_constellation_left.setImageResource(imags.getResourceId(Integer.parseInt(myInfo.getConstellation()) - 1, -1));
                holder.iv_constellation_right.setImageResource(imags.getResourceId(Integer.parseInt(otherInfo.getConstellation()) - 1, -1));
                imags.recycle();

                // set constellation text
                holder.tv_constellation_left.setText(myInfo.getConstellationText());
                holder.tv_constellation_right.setText(otherInfo.getConstellationText());

                holder.tv_constellation.setText(contents);
            } else {
                holder.ll_constellation.setVisibility(View.GONE);
                holder.today_total_fortune.setVisibility(View.VISIBLE);
    ...
    private void setCharmAds(int idx, Unse04Adapter.ViewHolder holder, CharmData data) {
    ...
    private void setCharmAdsImage(int idx, Unse04Adapter.ViewHolder holder, String id) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_constellation, tv_constellation_left, tv_constellation_right;
        ImageView iv_constellation_left, iv_constellation_right;
        ...
        ViewHolder(View v) {
            ...
            /* constellation data */
            ll_constellation = (LinearLayout) v.findViewById(R.id.ll_constellation);

            tv_constellation = (TextView) v.findViewById(R.id.tv_constellation);
            tv_constellation_left = (TextView) v.findViewById(R.id.tv_constellation_left);
            tv_constellation_right = (TextView) v.findViewById(R.id.tv_constellation_right);

            iv_constellation_left = (ImageView) v.findViewById(R.id.iv_constellation_left);
            iv_constellation_right = (ImageView) v.findViewById(R.id.iv_constellation_right);
