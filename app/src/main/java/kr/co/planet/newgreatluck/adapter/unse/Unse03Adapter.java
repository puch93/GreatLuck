...
public class Unse03Adapter extends RecyclerView.Adapter<Unse03Adapter.ViewHolder> implements View.OnClickListener {
    ...
    public Unse03Adapter(Activity act, ArrayList<String> contents_list, ArrayList<Integer> star_list, ArrayList<String> title_list, ArrayList<CharmData> charmAdsList, int title_drawable, String title, int type) {
        this.act = act;
    ...
    @NonNull
    @Override
    public Unse03Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_unse_contents, viewGroup, false);
        Unse03Adapter.ViewHolder viewHolder = new Unse03Adapter.ViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(@NonNull Unse03Adapter.ViewHolder holder, int i) {
        if (i == 0) {
    ...
    private void setCharmAds(int idx, Unse03Adapter.ViewHolder holder, CharmData data) {
    ...
    private void setCharmAdsImage(int idx, Unse03Adapter.ViewHolder holder, String id) {
