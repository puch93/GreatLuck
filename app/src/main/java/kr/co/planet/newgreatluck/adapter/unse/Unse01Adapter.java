...
public class Unse01Adapter extends RecyclerView.Adapter<Unse01Adapter.ViewHolder> implements View.OnClickListener {
    ...
    public Unse01Adapter(Activity act, ArrayList<String> contents_list, ArrayList<Integer> star_list, ArrayList<String> title_list, ArrayList<CharmData> charmAdsList, int title_drawable, String title, int type) {
        this.act = act;
    ...
    @NonNull
    @Override
    public Unse01Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_unse_contents, viewGroup, false);
        Unse01Adapter.ViewHolder viewHolder = new Unse01Adapter.ViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(@NonNull Unse01Adapter.ViewHolder holder, int i) {
        if (i == 0) {
    ...
    private void setCharmAds(int idx, Unse01Adapter.ViewHolder holder, CharmData data) {
            holder.tv_charms.get(idx).setText(data.getName());
            holder.ll_chars.get(idx).setOnClickListener(this);
            setCharmAdsImage(idx, holder, data.getId());
    }

    private void setCharmAdsImage(int idx, Unse01Adapter.ViewHolder holder, String id) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ArrayList<LinearLayout> ll_chars;
        ...
        ViewHolder(View v) {
            ...
            ll_chars = new ArrayList<>();
            ll_chars.add((LinearLayout) v.findViewById(R.id.ll_charm1));
            ll_chars.add((LinearLayout) v.findViewById(R.id.ll_charm2));
            ll_chars.add((LinearLayout) v.findViewById(R.id.ll_charm3));
