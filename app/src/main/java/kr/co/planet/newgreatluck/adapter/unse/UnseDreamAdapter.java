...
public class UnseDreamAdapter extends RecyclerView.Adapter<UnseDreamAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public UnseDreamAdapter(Activity act, ArrayList<String> contents_list, ArrayList<Integer> star_list, ArrayList<String> title_list, ArrayList<CharmData> charmAdsList, int title_drawable, String title, ArrayList<String> sub_list) {
        this.act = act;
    ...
    @NonNull
    @Override
    public UnseDreamAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_unse_dream, viewGroup, false);
        UnseDreamAdapter.ViewHolder viewHolder = new UnseDreamAdapter.ViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(@NonNull UnseDreamAdapter.ViewHolder holder, int i) {
        if (i == 0) {
            ...
            holder.rcv_sub.setVisibility(View.GONE);

            final String title = title_list.get(0);
            ...
            holder.ll_start_count_area.setVisibility(View.GONE);
//            for (int j = 0; j < 5; j++) {
//                holder.view_list.get(j).setVisibility(View.GONE);
//            }
            ...
            holder.rcv_sub.setVisibility(View.VISIBLE);
            holder.ll_bottom_charm.setVisibility(View.GONE);

            final String title = title_list.get(1);
            holder.today_title.setText(title);

            RecyclerView rcv_sub = holder.rcv_sub;

            rcv_sub.setHasFixedSize(true);
            rcv_sub.setLayoutManager(new LinearLayoutManager(act));
            rcv_sub.setAdapter(new UnseDreamSubAdapter(act, sub_list));
...
//                holder.view_list.get(j).setVisibility(View.GONE);
    ...
    private void setCharmAds(int idx, UnseDreamAdapter.ViewHolder holder, CharmData data) {
    ...
    private void setCharmAdsImage(int idx, UnseDreamAdapter.ViewHolder holder, String id) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /* contents data */
        LinearLayout ll_contents, ll_start_count_area;
        ...
        ViewHolder(View v) {
            ...
            ll_start_count_area = (LinearLayout) v.findViewById(R.id.ll_start_count_area);
            ...
            /* sub */
            rcv_sub = (RecyclerView) v.findViewById(R.id.rcv_sub);
