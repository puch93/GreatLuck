...
public class BIllingManager implements PurchasesUpdatedListener {
    ...
    String subscription_state = "none";
    ...
    public BIllingManager(Activity act, AfterBilling afterListener) {
        this.act = act;
                ...
                if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                    ...
                    if (purchasedList == null || purchasedList.size() == 0) {
                        ...
                        for (int i = 0; i < purchasedList.size(); i++) {
                            if (purchasedList.get(i).getSku().equals(SUBS_ONE) || purchasedList.get(i).getSku().equals(SUBS_THREE)) {
    ...
    public void getSkuDetailList() {
        ...
        Sku_ID_List.add(SUBS_ONE);
        Sku_ID_List.add(SUBS_THREE);
